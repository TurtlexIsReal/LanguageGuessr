const snippets = [
    ...
    { text: "Moien, kënnt Dir mech roden? Et ass net sou schwéier.", language: "Luxembourgish" },
    ...
    { text: "Salud, gallout a rit divinout ac'hanon ?  n'eo ket ken diaes-se", language: "Breton" },
    ...
    { text: "Sveiki, kaip tau sekasi? Ar galite mane atspėti? Tai nėra taip sunku.", language: "Hawaiian" }
];
